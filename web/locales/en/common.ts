export const CommonEn = {
  ...
  homeTip: 'Provide a 7*24H AI system digital butler for each application system, and can cooperate with real people. 7*24H deals with business problems, forming a 7*24H deep escort and protection net.',
