...
from derisk.core import BaseMessage, HumanPromptTemplate, LLMClient
from derisk.rag.transformer.llm_translator import LLMTranslator
...
Question: Introduce TuGraph and DERISK separately.
Return:
{{"category": "Freestyle Question", "rewritten_question": "Query the entity named TuGraph and the entity named DERISK, then return two-hop sub-graphs centered on them.", "entities": ["TuGraph", "DERISK"], "relations": []}}
---------------------
Text: {text}
Return:
