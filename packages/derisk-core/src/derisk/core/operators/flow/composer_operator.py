...
from derisk.core.awel.trigger.http_trigger import CommonLLMHttpRequestBody
from derisk.core.interface.llm import ModelRequest
from derisk.core.interface.message import MessageStorageItem, StorageConversation
from derisk.core.interface.operators.llm_operator import (
...
from derisk.core.interface.prompt import ChatPromptTemplate
from derisk.core.interface.storage import StorageInterface
...
class ConversationComposerOperator(MapOperator[CommonLLMHttpRequestBody, ModelRequest]):
    ...
    def _build_composer_dag(self):
        with DAG("derisk_awel_chat_history_prompt_composer") as composer_dag:
