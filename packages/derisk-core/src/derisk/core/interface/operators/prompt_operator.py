...
from derisk._private.pydantic import model_validator
from derisk.core import ModelMessage, ModelOutput, StorageConversation
...
from derisk.core.interface.operators.llm_operator import BaseLLM
from derisk.core.interface.operators.message_operator import BaseConversationOperator
...
class PromptBuilderOperator(
    ...
    Examples:
        .. code-block:: python
            ...
            from derisk.core.operators import PromptBuilderOperator
