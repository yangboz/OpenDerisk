...
from derisk._private.pydantic import BaseModel, Field, model_to_dict, model_validator
...
class UIUpload(UIComponent):
    ...
    action: Optional[str] = Field(
        "/api/v2/serve/file/files/derisk",
        description="The URL for the file upload(default bucket is 'derisk')",
    )
