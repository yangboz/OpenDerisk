...
_OLD_AGENT_OPERATOR_MODULE = "derisk.serve.agent.team.layout.agent_operator"
_NEW_AGENT_OPERATOR_MODULE = "derisk.agent.core.reasoning_engine.awel.agent_operator"

_OLD_AGENT_RESOURCE_MODULE_1 = "derisk.serve.agent.team.layout.agent_operator_resource"
_OLD_AGENT_RESOURCE_MODULE_2 = (
    "derisk.agent.reasoning_engine.awel.agent_operator_resource"
)
_NEW_AGENT_RESOURCE_MODULE = (
    "derisk.agent.core.reasoning_engine.awel.agent_operator_resource"
)
...
_register(
    "derisk.storage.vector_store.connector",
    "derisk.serve.rag.connector",
