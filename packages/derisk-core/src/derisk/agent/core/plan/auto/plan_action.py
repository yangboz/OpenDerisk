        ...
        **kwargs,
        ...
        try:
            ...
            try:
                ...
                logger.exception(str(e))
                fail_reason = (
                    f"The generated reasoning_engine cannot be stored, reason: {str(e)}."
                    f" Please check whether it is a problem with the reasoning_engine content. "
                    f"If so, please regenerate the correct reasoning_engine. If not, please return"
                    f" 'TERMINATE'."
                )
