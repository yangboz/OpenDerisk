...
class ReActPlannerAgent(ConversableAgent):
    ...
    profile: ProfileConfig = ProfileConfig(
        name=DynConfig(
            "Planner",
            category="agent",
            key="derisk_agent_plan_react_planner_agent_profile_name",
        ),
        role=DynConfig(
            "ReActPlanner",
            category="agent",
            key="derisk_agent_plan_react_planner_agent_profile_role",
        ),
        goal=DynConfig(
            ...
            把结论信息交给'final_report_agent'进行整理回复.  同时你思考过程和输出答案请准守下面给出的‘约束’""",
            category="agent",
    ...
    def prepare_act_param(
        ...
        **kwargs,
        ...
        return {
            ...
            "round": received_message.rounds,
            "round_id": received_message.message_id,
