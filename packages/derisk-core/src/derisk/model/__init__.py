try:
    from derisk.model.cluster.client import DefaultLLMClient, RemoteLLMClient
except ImportError:
...
def scan_model_providers():
    ...
    config = ScannerConfig(
        module_path="derisk.model.adapter",
