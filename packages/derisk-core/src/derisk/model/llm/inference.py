...
We have integrated fastchat. For details, see: derisk/model/model_adapter.py
"""
...
from derisk.model.utils.llm_utils import is_partial_stop, is_sentence_complete
