...
from derisk.rag.embedding.embedding_factory import DefaultEmbeddingFactory
...
class DBSchemaAssembler(BaseAssembler):
    ...
    Example:
        .. code-block:: python
            ...
            from derisk.datasource.rdbms.conn_sqlite import SQLiteTempConnector
            from derisk_serve.rag.assembler.db_struct import DBSchemaAssembler
