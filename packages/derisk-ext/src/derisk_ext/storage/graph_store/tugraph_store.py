...
from derisk.storage.graph_store.graph import GraphElemType
from derisk_ext.datasource.conn_tugraph import TuGraphConnector
    ...
    def _upload_plugin(self):
        ...
        if len(missing_plugins):
            for name in missing_plugins:
                try:
                    from derisk_tugraph_plugins import (  # type: ignore
