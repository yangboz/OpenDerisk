...
from derisk.storage.cache.operators import (
    CachedModelOperator,
...
class AppChatComposerOperator(MapOperator[ChatComposerInput, ModelRequest]):
    ...
    def _build_composer_dag(self) -> DAG:
        with DAG("derisk_awel_app_chat_history_prompt_composer") as composer_dag:
...
def build_cached_chat_operator(
    ...
    with DAG("derisk_awel_app_model_infer_with_cached") as _dag:
