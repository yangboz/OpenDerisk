...
from derisk.core import BaseOutputParser, ChatPromptTemplate
from derisk.core._private.example_base import ExampleSelector
...
class AppScenePromptTemplateAdapter(BaseModel):
    ...
    Include some fields that in :class:`derisk.core.PromptTemplate`
    """
