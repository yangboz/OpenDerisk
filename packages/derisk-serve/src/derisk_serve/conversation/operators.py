...
from derisk.core.awel.flow import IOField, OperatorCategory, ViewMetadata
from derisk.core.operators import PreChatHistoryLoadOperator
...
class ServePreChatHistoryLoadOperator(PreChatHistoryLoadOperator):
    """Pre-chat history load operator for DERISK serve component
...
class DefaultServePreChatHistoryLoadOperator(ServePreChatHistoryLoadOperator):
    """Default pre-chat history load operator for DERISK serve component
    ...
    metadata = ViewMetadata(
        ...
        description=_(
            ...
            "It is the default storage of DERISK"
        ),
        parameters=[],
        inputs=[
            IOField.build_from(
