...
from derisk_ext.rag.summary.gdbms_db_summary import GdbmsSummary
from derisk_ext.rag.summary.rdbms_db_summary import RdbmsSummary
...
class DBSummaryClient:
    ...
    def get_db_summary(self, dbname, query, topk):
        ...
        from derisk_ext.rag.retriever.db_schema import DBSchemaRetriever
    ...
    def init_db_profile(self, db_summary_client, dbname):
        ...
        if not table_vector_connector.vector_name_exists():
            from derisk_ext.rag.assembler.db_schema import DBSchemaAssembler
            from derisk_ext.rag.summary.rdbms_db_summary import (
