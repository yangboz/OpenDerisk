        ...
        try:
            ...
            if not gpts_app:
                return ActionOutput(
                    is_exe_success=False,
                    content=ai_message,
                    view=f"[DERISK Warning] Intent definition application cannot be "
            ...
            if TeamMode.NATIVE_APP.value == gpts_app.team_mode:
                return ActionOutput(
                    is_exe_success=False,
                    content=ai_message,
                    view="[DERISK Warning] Native application connection startup is not"
            ...
            return ActionOutput(
                is_exe_success=False,
                content=ai_message,
                view=f"[DERISK Warning] An exception occurred during the answering "
