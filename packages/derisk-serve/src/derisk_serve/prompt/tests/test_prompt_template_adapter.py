...
from derisk.core.interface.prompt import PromptManager, PromptTemplate
...
def test_list(prompt_manager: PromptManager):
    for i in range(10):
        ...
        prompt_manager.save(
            ...
            sys_code="derisk" if i % 2 == 0 else "not_derisk",
        )
    # Test list all
    ...
    assert len(prompt_manager.list(sys_code="derisk")) == 5
