...
APP_NAME = "model"
SERVE_APP_NAME = "derisk_serve_model"
SERVE_APP_NAME_HUMP = "derisk_serve_Model"
SERVE_CONFIG_KEY_PREFIX = "derisk_serve.model."
SERVE_SERVICE_COMPONENT_NAME = f"{SERVE_APP_NAME}_service"
# Database table name
SERVER_APP_TABLE_NAME = "derisk_serve_model"
