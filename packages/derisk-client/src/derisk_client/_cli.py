...
from derisk.core.awel import DAG, BaseOperator, DAGVar
from derisk.core.awel.dag.dag_manager import DAGMetadata, _parse_metadata
...
def _check_local_dag(
    ...
    from derisk.core.awel import HttpTrigger
...
def _parse_local_dag(name: str, filepath: str | None = None) -> Tuple[DAG, DAGMetadata]:
    ...
    if not filepath:
        # Load DAG from installed package(derisks)
        ...
        from derisk.core.awel.dag.loader import _process_file
